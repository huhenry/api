...
type MeshConfig struct {
	...
	// A list of Kubernetes selectors that specify the set of services/pods that Istio considers when
	// computing configuration updates for sidecars. This can be used to reduce Istio's computational load
	// by limiting the number of entities (including services, pods, and endpoints) that are watched and processed.
	// If omitted, Istio will use the default behavior of processing all resources in the cluster.
	// Elements in the list are disjunctive (OR semantics), i.e. a namespace will be included if it matches any selector.
	// The following example selects any namespace that matches either below:
	// 1. The namespace has both of these labels: `env: prod` and `region: us-east1`
	// 2. The namespace has label `app` equal to `cassandra` or `spark`.
	...
	// Refer to the [kubernetes selector docs](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)
	// for additional detail on selector semantics.
	DiscoveryServiceSelectors *v1.LabelSelector `protobuf:"bytes,63,opt,name=discovery_service_selectors,json=discoveryServiceSelectors,proto3" json:"discoveryServiceSelectors,omitempty"`
...
func (m *MeshConfig) GetDiscoveryServiceSelectors() *v1.LabelSelector {
	if m != nil {
		return m.DiscoveryServiceSelectors
	}
	return nil
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
	...
	0xcc, 0x6d, 0xfd, 0xac, 0x3c, 0xe1, 0x74, 0x97, 0xc7, 0x3b, 0x5e, 0xde, 0x35, 0x7a, 0x47, 0xd2,
	...
	0x1b, 0x6a, 0xb9, 0x77, 0x34, 0x5b, 0x5d, 0x72, 0x8d, 0x90, 0x93, 0xdd, 0xfb, 0x25, 0x94, 0xfc,
	...
	0xe7, 0x91, 0x14, 0x89, 0xa3, 0x5f, 0xc0, 0x4a, 0xb2, 0xed, 0xe6, 0xa4, 0x61, 0x7a, 0x26, 0x83,
	...
	0x11, 0x14, 0xfd, 0x1a, 0x8a, 0xdd, 0x2d, 0x3c, 0xe8, 0x77, 0x18, 0xf1, 0x69, 0xe2, 0x4c, 0x9f,
	...
	0x6f, 0xaa, 0x03, 0x3d, 0x39, 0xdc, 0xa4, 0x8e, 0xac, 0x7b, 0x4e, 0x0a, 0xfd, 0x0d, 0x14, 0x44,
	...
	0x3f, 0x57, 0x30, 0xeb, 0x57, 0x06, 0x9c, 0x8a, 0x9b, 0xf5, 0x08, 0x3a, 0x86, 0x05, 0x7a, 0x26,
	0x68, 0xc4, 0xa5, 0x23, 0xf7, 0x59, 0x7c, 0x1a, 0xf8, 0x94, 0x71, 0xe7, 0x17, 0xca, 0x8e, 0x57,
	0x26, 0xcd, 0x7a, 0x22, 0x7a, 0x60, 0x24, 0x5d, 0x44, 0x2f, 0x92, 0x38, 0xfa, 0x0d, 0x14, 0x93,
	...
	0x9d, 0x5f, 0xaa, 0x25, 0x3c, 0x2b, 0xeb, 0xfa, 0xb8, 0x9c, 0xae, 0x8f, 0xcb, 0xfd, 0x93, 0x8e,
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DiscoveryServiceSelectors != nil {
		{
			size, err := m.DiscoveryServiceSelectors.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MeshConfig_ExtensionProvider_OpenCensusAgentTracingProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Context) > 0 {
		dAtA39 := make([]byte, len(m.Context)*10)
		var j38 int
...
func (m *ConfigSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SubscribedResources) > 0 {
		dAtA41 := make([]byte, len(m.SubscribedResources)*10)
		var j40 int
...
func (m *MeshConfig) Size() (n int) {
	...
	if m.DiscoveryServiceSelectors != nil {
		l = m.DiscoveryServiceSelectors.Size()
		n += 2 + l + sovConfig(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 63:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DiscoveryServiceSelectors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DiscoveryServiceSelectors == nil {
				m.DiscoveryServiceSelectors = &v1.LabelSelector{}
			}
			if err := m.DiscoveryServiceSelectors.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
