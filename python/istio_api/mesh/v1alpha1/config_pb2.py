...
_MESHCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='discovery_service_selectors', full_name='istio.mesh.v1alpha1.MeshConfig.discovery_service_selectors', index=42,
      number=63, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='discoveryServiceSelectors', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
_MESHCONFIG.fields_by_name['discovery_service_selectors'].message_type = k8s_dot_io_dot_apimachinery_dot_pkg_dot_apis_dot_meta_dot_v1_dot_generated__pb2._LABELSELECTOR
